...
新增job方式的访问
    第一步：localhost:9200/_commandjob?q=<command>&from=0&size=50，返回{"jobid":"299450.5410349557"}
    第二步：
        localhost:9200/jobs/299450.5410349557/query, 使用jobid取查询结果
        localhost:9200/jobs/299450.5410349557/report, 使用jobid取统计结果
版本号的发布规定
